...
We tend to overestimate the overall magnitude of the positive and negative feelings generated by an event (not ours). Because observers see the momentary elation or despair as more extreme or more enduring than it actually is, we make inferences about the disposition (Jones)